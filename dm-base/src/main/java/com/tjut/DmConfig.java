...
public class DmConfig {
    private final static String version = ResourceBundle.getBundle("config").getString("ver");
    ...
    public void version(){
        log.info("大漠插件版本:{}",dm.invoke("Ver").getString());
    }

    public void register(){
        int success = Dispatch.call(dm,"Reg",license,version).getInt();
        log.info("正在注册插件:{}",success == 1 ? "注册成功" : "注册失败");
    }
